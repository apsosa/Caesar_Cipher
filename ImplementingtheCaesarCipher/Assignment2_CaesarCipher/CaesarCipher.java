...
public class CaesarCipher
{
    ...
    public void testCaesar(){
        ...
        */
        ...
        //System.out.println( encryptTwoKeys("Akag tjw Xibhr awoa aoee xakex znxag xwko",26-2,26-20));
        int count = 0;
        for(int k = 0; k< 27;k++){
            for(int j = 0; j< 27;j++){
                count++;
                if(count > 0 && count < 200){                
                    System.out.println( encryptTwoKeys("Xifqvximt tsdtlxzrx iijirvtl ek Uybi afvbw yehvv xyi gfqdse",26-k,26-j));
                }
            }
        }
    }
